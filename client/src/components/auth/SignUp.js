...
const SignUp = (props) => {
  ...
  const onSubmit = (e) => {
    ...
    if (username === "") {
      ...
      setAlert('Password should be at least 6 character, Please recreate it', 'danger');
    }
    else if (password === "")  {
  ...
  return (
    ...
    <div className='form-container'>
      ...
      <form onSubmit={onSubmit}>
        ...
        <Button className = "ml-5" value='Register' type='submit' variant="info">sign up</Button>
        </form>
    </div>
  );
};
