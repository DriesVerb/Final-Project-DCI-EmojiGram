...
const UserItem = (props) => {
  ...
  const { _id,  username, email, age, location, followers } = user;
      ...
      <div className="col-md-7 mx-auto">
        ...
        <div className="bg-white shadow rounded overflow-hidden">
          ...
          <h4> {username.charAt(0).toUpperCase() + username.slice(1)}</h4>
                ...
                {email && <p className="small mb-4 mt-3"> <i className="fas fa-paper-plane mr-2"></i>{email}</p>}
{/*         
        {location && ( */}
        ...
        >
          Delete
                  ...
                  <li class="list-inline-item p-3">
                    ...
                    {followers && (<h5 class="font-weight-bold mb-0 d-block">{followers.length}</h5>)}
                    
                    
                    
                    <small class="text-muted"> <i class="fas fa-book mr-1"></i>Stories</small>
                            </li>
            ...
            <div class="px-4 py-3">
              ...
              {age && <p class="font-italic mb-0"> {age}</p>}
                </div> <Link to="/yourstories" className="link"><button  className="btn btn-secondary btn-lg btn-block ">Stories </button></Link>
            </div>
